...
**Movie Search Chatbot** — это интерактивный чат-бот, предназначенный для поиска фильмов, анализа информации по актёрам и режиссёрам, а также рекомендаций похожих фильмов на основе вашего описания.
...
6. **Парсинг данных:** Произведён парсинг данных с портала **IMDb**, где было спарсено более 5000 фильмов. Этими данными были заполнены как SQL-база, так и векторнуя база FAISS, что позволяет агентам эффективно доставать информацию о фильмах в полном объеме.
